...
@Generated(hash = 1353901081)
public DogEntity(Long _id, Long userId, @NotNull String name, Double age, String breed,
        Boolean pureBreed, String color, String description) {
    this._id = _id;
    this.userId = userId;
    this.name = name;
    this.age = age;
...
@Generated(hash = 1376661605)
private transient Long query__resolvedKey;
/** To-one relationship, resolved on first access. */
@Generated(hash = 309885839)
public QueryEntity getQuery() {
    Long __key = this._id;
    if (query__resolvedKey == null || !query__resolvedKey.equals(__key)) {
